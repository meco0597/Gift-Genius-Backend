    ...
    public static class TestData
    {
        public static List<GiftSuggestion> TestGiftSuggestions = new List<GiftSuggestion>()
        {
            new GiftSuggestion()
            {
                ...
                AssociatedRelationships = new List<RelationshipDescriptor>() { RelationshipDescriptor.Parent, RelationshipDescriptor.Grandparent, RelationshipDescriptor.Partner, RelationshipDescriptor.Child },
            ...
            new GiftSuggestion()
            {
                ...
                AssociatedRelationships = new List<RelationshipDescriptor>() { RelationshipDescriptor.Parent, RelationshipDescriptor.Friend, RelationshipDescriptor.Partner, RelationshipDescriptor.Child },
            ...
            new GiftSuggestion()
            {
                ...
                AssociatedRelationships = new List<RelationshipDescriptor>() { RelationshipDescriptor.Parent, RelationshipDescriptor.Sibling, RelationshipDescriptor.Partner },
            ...
            new GiftSuggestion()
            {
                ...
                AssociatedRelationships = new List<RelationshipDescriptor>() { RelationshipDescriptor.Parent, RelationshipDescriptor.Partner, RelationshipDescriptor.Child },
            ...
            new GiftSuggestion()
            {
                ...
                AssociatedRelationships = new List<RelationshipDescriptor>() { RelationshipDescriptor.Partner, RelationshipDescriptor.Child, RelationshipDescriptor.Sibling },
