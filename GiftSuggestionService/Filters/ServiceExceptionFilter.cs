    ...
    public class ServiceExceptionFilter : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            try
            {
                ...
                {
                    Console.Error.WriteLine($"OnException: Unhandled Exception:{exceptionToLog?.Message} InnerException:{exceptionToLog?.InnerException} StackTrace:{exceptionToLog?.StackTrace} SourceFile:{exceptionToLog.Source}");
                }
                else
                {
